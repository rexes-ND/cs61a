...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    nfactors = num_factors(score)
    if nfactors == 3 or nfactors == 4:
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while score0 < goal:
        score1 = 0
        while score1 < goal:
            if strategy(score0, score1) != rolls:
                return False
            score1 += 1
        score0 += 1
    return True
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    roll = 1
    while roll <= 10:
        cur_average = make_averaged(roll_dice, samples_count)(roll, dice)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    if sus_update(0, score, opponent_score) >= threshold + score:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
